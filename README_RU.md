...
**MAC-адреса и производители устройств недоступны на iOS 11+** из-за ограничений конфиденциальности Apple. Это системное ограничение, затрагивающее все приложения для сканирования сети.
